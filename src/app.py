...
app.add_url_rule(routes['show_categories_route'], view_func=routes['show_categories_controller'])
app.add_url_rule(routes['delete_category_route'], view_func=routes['delete_category_controller'])
